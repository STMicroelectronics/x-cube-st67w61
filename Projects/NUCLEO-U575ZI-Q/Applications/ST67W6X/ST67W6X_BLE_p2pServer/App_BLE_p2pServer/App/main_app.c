...
#define P2PSERVER_LED_CHAR_PROPERTY         W6X_BLE_CHAR_PROP_WRITE_WITHOUT_RESP
#define P2PSERVER_SWITCH_CHAR_PROPERTY      W6X_BLE_CHAR_PROP_NOTIFY

#define P2PSERVER_LED_CHAR_PERMISSION       W6X_BLE_CHAR_PERM_WRITE
#define P2PSERVER_SWITCH_CHAR_PERMISSION    W6X_BLE_CHAR_PERM_READ
...
{
  {
    ...
    .char_property = P2PSERVER_LED_CHAR_PROPERTY,
    .char_permission = P2PSERVER_LED_CHAR_PERMISSION,
  ...
  },
  {
    ...
    .uuid_type = W6X_BLE_UUID_TYPE_128,
    .char_property = P2PSERVER_SWITCH_CHAR_PROPERTY,
    .char_permission = P2PSERVER_SWITCH_CHAR_PERMISSION,
...
void MX_App_BLE_p2pServer_Init(void);
void MX_App_BLE_p2pServer_Init(void)
{
