...
> This project requires to use the ST67W611M Coprocessor binary st67w611m_mission_t02_v2.0.97.bin.
>
...
|ST67W6X_CLI_LWIP/Appli/Target/freertos_tickless.h|                               |Management of timers and ticks header file|
|ST67W6X_CLI_LWIP/Appli/Target/logshell_ctrl.h|                                   |Header for logshell_ctrl.h|
|ST67W6X_CLI_LWIP/Appli/Target/stm32_lpm_if.h|                                    |Header for stm32_lpm_if.c module (device specific LP management)|
|ST67W6X_CLI_LWIP/Appli/Target/utilities_conf.h|                                  |Header for configuration file to utilities|
...
|ST67W6X_CLI_LWIP/Core/Inc/stm32u5xx_hal_conf.h|                                  |HAL configuration file.|
|ST67W6X_CLI_LWIP/Core/Inc/stm32u5xx_it.h|                                        |This file contains the headers of the interrupt handlers.|
...
|ST67W6X_CLI_LWIP/LWIP/App/altcp_tls_mbedtls.h|                                   |Application layered TCP/TLS connection API|
|ST67W6X_CLI_LWIP/LWIP/App/dhcp_server.h|                                         |DHCP Server definition|
|ST67W6X_CLI_LWIP/LWIP/App/echo.h|                                                |Echo test definition|
...
|ST67W6X_CLI_LWIP/LWIP/App/sntp.h|                                                |This is simple "SNTP" client definition|
...
|ST67W6X_CLI_LWIP/ST67W6X/App/app_st67w6x.h|                                      |This file provides code for the configuration of the STMicroelectronics.X-CUBE-ST67W61.1.2.0 instances.|
...
|ST67W6X_CLI_LWIP/Appli/Target/freertos_tickless.c|                               |Management of timers and ticks|
|ST67W6X_CLI_LWIP/Appli/Target/logshell_ctrl.c|                                   |logshell_ctrl (uart interface)|
|ST67W6X_CLI_LWIP/Appli/Target/stm32_lpm_if.c|                                    |Low layer function to enter/exit low power modes (stop, sleep)|
...
|ST67W6X_CLI_LWIP/Core/Src/stm32u5xx_hal_msp.c|                                   |This file provides code for the MSP Initialization<br>and de-Initialization codes.|
|ST67W6X_CLI_LWIP/Core/Src/stm32u5xx_hal_timebase_tim.c|                          |HAL time base based on the hardware TIM.|
|ST67W6X_CLI_LWIP/Core/Src/stm32u5xx_it.c|                                        |Interrupt Service Routines.|
|ST67W6X_CLI_LWIP/Core/Src/system_stm32u5xx.c|                                    |CMSIS Cortex-M33 Device Peripheral Access Layer System Source File|
...
|ST67W6X_CLI_LWIP/LWIP/App/altcp_tls_mbedtls.c|                                   |Application layered TCP/TLS connection API|
|ST67W6X_CLI_LWIP/LWIP/App/dhcp_server_raw.c|                                     |A simple DHCP server implementation|
|ST67W6X_CLI_LWIP/LWIP/App/echo.c|                                                |Test an echo with a server|
...
|ST67W6X_CLI_LWIP/LWIP/App/sntp.c|                                                |This is simple "SNTP" client for the lwIP raw API.<br>It is a minimal implementation of SNTPv4 as specified in RFC 4330.|
|ST67W6X_CLI_LWIP/ST67W6X/App/app_st67w6x.c|                                      |This file provides code for the configuration of the STMicroelectronics.X-CUBE-ST67W61.1.2.0 instances.|
