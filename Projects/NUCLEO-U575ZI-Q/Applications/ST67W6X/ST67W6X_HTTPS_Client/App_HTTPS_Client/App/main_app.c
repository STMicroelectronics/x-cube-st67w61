...
{
  .name = "ST67W6X Wi-Fi HTTPS Client",
...
void main_app(void)
{
  ...
  /* Run HTTPS Client */
  if (https_client_weather(NULL, 45, -73) != 0)
  {
    goto _err;
  }
...
#elif (TEST_AUTOMATION_ENABLE == 1)
  vTaskDelay(5000);
#else
  while (1);
#endif /* SHELL_ENABLE || TEST_AUTOMATION_ENABLE */
...
void MX_App_HTTPS_Client_Init(void);
void MX_App_HTTPS_Client_Init(void)
{
