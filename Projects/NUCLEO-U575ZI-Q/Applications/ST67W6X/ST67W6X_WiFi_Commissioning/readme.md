...
For further information, please visit the dedicated Wiki page [ST67W6X_WiFi_Commissioning](https://wiki.st.com/stm32mcu/wiki/Connectivity:Wifi_ST67W6X_WiFi_Commissioning_Application).

## __Directory structure__

|Directory  |                                                                     |Description|
|---   |:-:                                                                       |---        |
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/|                          |Main application code directory|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/|                       |Logging, Shell, Low-Power and SPI BSP interfaces|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Core/Src|                      |STM32CubeMX generated sources code|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Core/Inc|                      |STM32CubeMX generated header files|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/ST67W6X/Target|                |Configuration and port files to manage the ST67W6X_Network_Driver Middleware|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Html|                          |Definition and tools for converting HTML pages into header file|
...
|File  |                                                                          |Description|
|---   |:-:                                                                       |---        |
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/app_config.h|              |Configuration for main application|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/html_pages.h|              |index.html conversion in hex array|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/httpserver.h|              |Http server declarations.|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/main_app.h|                |Header for main_app.c|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/freertos_tickless.h|    |Management of timers and ticks header file|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/logshell_ctrl.h|        |Header for logshell_ctrl.h|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/spi_port_conf.h|        |Interfaces/maps the SPI instance to be used for NCP communication|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/stm32_lpm_if.h|         |Header for stm32_lpm_if.c module (device specific LP management)|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/utilities_conf.h|       |Header for configuration file to utilities|
...
|      |                                                                          |           |
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/httpserver.c|              |Http server application.|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/App/main_app.c|                |main_app program body|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/freertos_tickless.c|    |Management of timers and ticks|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/logshell_ctrl.c|        |logshell_ctrl (uart interface)|
|ST67W6X_WiFi_Commissioning/App_WiFi_Commissioning/Target/stm32_lpm_if.c|         |Low layer function to enter/exit low power modes (stop, sleep)|
...
The Wi-Fi configuration used in this application is define in the _App_HTTP_Server/App/app_config.h_ file :
```
...
#define WIFI_SAP_SECURITY           W6X_SECURITY_WPA2_PSK

#define WIFI_SAP_MAX_CONNECTIONS    4
```

The logging output mode can be modified in the _App_HTTP_Server/App/app_config.h_ file :
```
/** Select output log mode [0: printf / 1: UART / 2: ITM] */
#define LOG_OUTPUT_MODE             LOG_OUTPUT_UART
```

The host low power mode can be modified in the _App_HTTP_Server/App/app_config.h_ file :
```
