...
W6X_WiFi_Connect_Opts_t connect_opt = {0};
uint32_t credentials = 0;
...
{
  .name = "ST67W6X Wi-Fi Commissioning",
...
void main_app(void)
{
  ...
  while (1)
  {
    ...
    /* First try to connect the STA. Testing channel compatibility */
    if (W6X_WiFi_Connect(&connect_opt) == W6X_STATUS_OK)
    {
...
void MX_App_WiFi_Commissioning_Init(void);
void MX_App_WiFi_Commissioning_Init(void)
{
