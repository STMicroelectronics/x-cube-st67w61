...
For further information, please visit the dedicated Wiki page [ST67W6X_FOTA](https://wiki.st.com/stm32mcu/wiki/Connectivity:Wifi_ST67W6X_FOTA_Application).

## __Directory structure__

|Directory  |                                                                     |Description|
|---   |:-:                                                                       |---        |
|ST67W6X_FOTA/App_FOTA/App/|                                                      |Main application code directory|
|ST67W6X_FOTA/App_FOTA/Target/|                                                   |Logging, Shell, Low-Power and SPI BSP interfaces|
|ST67W6X_FOTA/App_FOTA/Core/Src|                                                  |STM32CubeMX generated sources code|
|ST67W6X_FOTA/App_FOTA/Core/Inc|                                                  |STM32CubeMX generated header files|
|ST67W6X_FOTA/App_FOTA/ST67W6X/Target|                                            |Configuration and port files to manage the ST67W6X_Network_Driver Middleware|
...
|File  |                                                                          |Description|
|---   |:-:                                                                       |---        |
|ST67W6X_FOTA/App_FOTA/App/app_config.h|                                          |Configuration for main application|
|ST67W6X_FOTA/App_FOTA/App/fota.h|                                                |FOTA test definition|
|ST67W6X_FOTA/App_FOTA/App/fota_flash.h|                                          |Header file for Flash operations used in FOTA.|
|ST67W6X_FOTA/App_FOTA/App/fota_header.h|                                         |Header file for FOTA header parsing and handling.|
|ST67W6X_FOTA/App_FOTA/App/fota_header_struct.h|                                  |FOTA header structure definition|
|ST67W6X_FOTA/App_FOTA/App/main_app.h|                                            |Header for main_app.c|
|ST67W6X_FOTA/App_FOTA/App/sha256.h|                                              |This file is part of mbed TLS and used for sha256 computation.|
|ST67W6X_FOTA/App_FOTA/Target/freertos_tickless.h|                                |Management of timers and ticks header file|
|ST67W6X_FOTA/App_FOTA/Target/logshell_ctrl.h|                                    |Header for logshell_ctrl.h|
|ST67W6X_FOTA/App_FOTA/Target/spi_port_conf.h|                                    |Interfaces/maps the SPI instance to be used for NCP communication|
|ST67W6X_FOTA/App_FOTA/Target/stm32_lpm_if.h|                                     |Header for stm32_lpm_if.c module (device specific LP management)|
|ST67W6X_FOTA/App_FOTA/Target/utilities_conf.h|                                   |Header for configuration file to utilities|
...
|      |                                                                          |           |
|ST67W6X_FOTA/App_FOTA/App/fota.c|                                                |Test a FOTA with a server|
|ST67W6X_FOTA/App_FOTA/App/fota_flash.c|                                          |This file provides code for Flash operations used in FOTA.|
|ST67W6X_FOTA/App_FOTA/App/fota_header.c|                                         |This file provides code for parsing and handling FOTA headers.|
|ST67W6X_FOTA/App_FOTA/App/main_app.c|                                            |main_app program body|
|ST67W6X_FOTA/App_FOTA/App/sha256.c|                                              |This file is part of mbed TLS and used for sha256 computation.|
|ST67W6X_FOTA/App_FOTA/Target/freertos_tickless.c|                                |Management of timers and ticks|
|ST67W6X_FOTA/App_FOTA/Target/logshell_ctrl.c|                                    |logshell_ctrl (uart interface)|
|ST67W6X_FOTA/App_FOTA/Target/stm32_lpm_if.c|                                     |Low layer function to enter/exit low power modes (stop, sleep)|
...
The Wi-Fi configuration used in this application is define in the _App_FOTA/App/app_config.h_ file :
```
...
The logging output mode can be modified in the _App_FOTA/App/app_config.h_ file :
```
/** Select output log mode [0: printf / 1: UART / 2: ITM] */
#define LOG_OUTPUT_MODE             LOG_OUTPUT_UART
```

The host low power mode can be modified in the _App_FOTA/App/app_config.h_ file :
```
/** Low power configuration [0: disable / 1: sleep / 2: stop / 3: standby] */
#define LOW_POWER_MODE              LOW_POWER_SLEEP_ENABLE
```

The fota configuration can be modified  in the _App_FOTA/App/app_config.h_ file :
```
