                                   ...
                                   FotaHeader_t *header)
{
  ...
  fota_args.ota_buffer = pvPortMalloc(FOTA_HEADER_SIZE);
  if (fota_args.ota_buffer == NULL)
  {
  ...
  if (fota_header_ParseJsonToStruct(fota_args.ota_buffer, fota_args.ota_data_accumulated,
                                ...
                                uint8_t *integrity_output)
{
  ...
  fota_args.ota_buffer = pvPortMalloc(4096);
  if (fota_args.ota_buffer == NULL)
  {
    LogError("Failed to allocate buffer for OTA header transmission\n");
    goto _err3;
